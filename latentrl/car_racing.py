...
def process_frame(
    ...
    return np.array(obs) # without scaling, dtype:uint8
...
class CarRacingWrapper(CarRacing):
    ...
    def __init__(self, frame_processer, seed=None):
        super().__init__()
        if seed:
            self.seed(int(seed))
        ...
        self.frame_processer = frame_processer
    ...
    def step(self, action, save_img=False):
        ...
        #     save_img=save_img
        # )
        obs = self.frame_processer(frame)
