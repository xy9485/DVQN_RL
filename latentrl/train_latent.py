...
from utils.misc import ProcessFrame, linear_schedule
...
def train_vanilla(algo_class: Type[BaseAlgorithm], policy: str, env_id: str, total_time_steps: int, device, seed: int):
    env = make_vec_env(env_id, 1, seed=seed)
