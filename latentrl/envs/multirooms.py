...
class MultiRoomEnv(MiniGridEnv):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._gen_grid(self.width, self.height, seed)
        self.agent_init_pos = self.agent_pos
        self.agent_init_dir = self.agent_dir
        # self.goal_init_pos = self.goal_pos

    @staticmethod
    def _gen_mission():
        return "traverse the rooms to get to the goal"

    def _gen_grid(self, width, height, seed):
        super(MiniGridEnv, self).reset(seed=seed)
        roomList = []
    ...
    def _reward(self) -> float:
        ...
        return 1000 - 300 * (self.step_count / self.max_steps)
